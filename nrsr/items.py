...
class BillStepItem(scrapy.Item):
    ...
    external_id = scrapy.Field(output_processor=TakeFirst())
    main_label = scrapy.Field(output_processor=TakeFirst())
    body_label = scrapy.Field(output_processor=TakeFirst())
    meeting_panel = scrapy.Field(output_processor=TakeFirst())
    meeting_session_num = scrapy.Field(output_processor=TakeFirst())
    meeting_resolution = scrapy.Field(output_processor=TakeFirst())
    committees_label = scrapy.Field(output_processor=TakeFirst())
    slk_label = scrapy.Field(output_processor=TakeFirst())
    coordinator_label = scrapy.Field(output_processor=TakeFirst())
    coordinator_meeting_date = scrapy.Field(output_processor=TakeFirst())
    coordinator_name = scrapy.Field(output_processor=TakeFirst())
    step_result = scrapy.Field(output_processor=TakeFirst())
    discussed_label = scrapy.Field(output_processor=TakeFirst())
    sent_standpoint = scrapy.Field(output_processor=TakeFirst())
    sent_label = scrapy.Field(output_processor=TakeFirst())
    act_num_label = scrapy.Field(output_processor=TakeFirst())
    url = scrapy.Field(output_processor=TakeFirst())
